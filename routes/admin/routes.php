...
use App\Http\Controllers\Admin\Reseller\ResellerController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'resellers', 'as' => 'reseller.','middleware'=>['module:user_section']], function () {
        Route::controller(ResellerController::class)->group(function (){
            Route::get(Reseller::LIST[URI], 'index')->name('reseller-list');
            Route::get(Reseller::VIEW[URI].'/{id}', 'getView')->name('view');
