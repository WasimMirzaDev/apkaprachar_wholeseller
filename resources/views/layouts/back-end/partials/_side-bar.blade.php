                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('user_section'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/seller*') || Request::is('admin/sellers/withdraw-method/*') ? 'active' : '' }}">
                             ...
                             <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/resellers*') }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{translate('Resellers')}}">
                                    <i class="tio-users-switch nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Resellers')}}</span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{Request::is('admin/customer*')?'block':'none'}}">
                                    <li class="nav-item {{Request::is('admin/resellers/'.Reseller::LIST[URI]) ||Request::is('admin/resellers/'.Reseller::VIEW[URI].'*') ?'active':''}}">
                                        <a class="nav-link" title="{{translate('Reseller List')}}"
                                           href="{{route('admin.reseller.reseller-list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                        {{translate('Reseller List')}}
                                    </span>
                                        </a>
                                    </li>
                                </ul>
